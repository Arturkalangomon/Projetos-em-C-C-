...
int main() //função principal do programa...
{
   ...
   install_timer(); //define os timers (será usado no game)...
   install_keyboard(); //inicializa o teclado
   set_color_depth(32); //cor de fundo da janela
   set_gfx_mode(GFX_AUTODETECT_WINDOWED, 800, 600, 0, 0); //define o tamanho da janela automatico... e detecta o driver(auto)...
